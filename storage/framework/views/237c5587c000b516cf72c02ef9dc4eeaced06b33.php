...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content email-content">
            ...
            <span class="title">Email Agent</span>
            <div class="property-detail-block">
                <div class="img-holder" >
                    <img id="modalImg" src="" alt="">
                </div>
                <div class="detail-holder" >
                    <h3 id="modalName"><?php echo e('Proprty title'); ?></h3>
                    <strong class="price"><?php echo e(''); ?></strong>

                    <span class="agent-detail">Agent:
                        <strong id="modalAgent"><?php echo e(''); ?></strong></span>

                    <span class="agent-detail">Broker:
                        <strong id="modalBroker"><?php echo e(''); ?></strong></span>

                    <ul class="property-feature">
                        <li><i class="fas fa-bed"></i><span id="modalBedrooms"><?php echo e(''); ?></span></li>
                        <li><i class="fas fa-bath"></i><span id="modalBathrooms"><?php echo e(''); ?></span></li>
                        <li><i class="fas fa-chart-area"></i><span id="modalSqm"><?php echo e(''); ?></span></li>
                    </ul>
                </div>
            </div>
        
                <?php echo e(Form::open(array('url' => 'send-email-agent','class'=>'','role'=>'form'))); ?>

                
                <input type="hidden" name="property_data" value="<?php echo e($property->id ??''); ?>">
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="user_message" rows="3"
                        placeholder="Hi, I found your property with ref: On saakin.com. Please contact me. Thank you." required></textarea>
                </div>
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            
                            <select name="countryCode" id="countryCodeSelect" class="form-control"
                                onchange="fillTelephoneInput(this)">
...
</script><?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/pages/include/emailModal.blade.php ENDPATH**/ ?>