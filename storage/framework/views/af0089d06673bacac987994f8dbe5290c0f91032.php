 ...
 <input type="hidden" id="globalPropertyPurposeValue" value="<?php echo e($request->property_purpose ?? 'Rent'); ?>">
 <input type="hidden" id="globalPropertyTypeValue" value="<?php echo e(request('type')->id ?? ''); ?>">
...
<div class="footer-wrapper v3">
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="footer-logo"><a href="<?php echo e(URL::to('/')); ?>">
                            <img src="<?php echo e(URL::asset('upload/logo.png')); ?>"
                                alt="<?php echo e(getcong('site_name') . 'Logo Pic'); ?>">
                        </a></div>
                </div>
                <div class="col-md-3 ml-auto">
                    <div class="footer-social-wrap text-white" >
                        ...
                        <ul class="social-buttons style2">
                            <li><a target="_blank" href="<?php echo e(getcong('social_facebook')); ?>">
                                <i class="fab fa-facebook-f"></i></a>
                            </li>
                            <li><a target="_blank" href="<?php echo e(getcong('social_instagram')); ?>">
                                <i class="fab fa-instagram"></i></a></li>
                            <li><a target="_blank" href="<?php echo e(getcong('social_linkedin')); ?>">
            ...
            <div class="row nav-folderized">
                <div class="col-lg-3 col-md-12">
                    <div class="footer-content nav">
                        <h2 class="title"><?php echo e(getcong('footer_widget1_title')); ?></h2>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="footer-content nav">
                        <h2 class="title"><?php echo e(getcong('footer_widget2_title')); ?></h2>
                        <ul class="list res-list">
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="footer-content nav">
                        <h2 class="title"><?php echo e(getcong('footer_widget3_title')); ?></h2>
                        <ul class="list res-list">
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="footer-content">
                        ...
                        <div class="value-input-wrap newsletter">
                            <?php echo $__env->make('front.pages.include.newsletter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8 offset-md-2">
                    <p style="color: white;"> <?php echo getcong('site_copyright'); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('front.modals.userlogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('front.pages.include.emailModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('front.modals.propertyReportModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('front.layouts.jsscripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->yieldContent('scripts-custom'); ?>
...
<script>
    ...
    $('#country').on('keyup', function() {
        ...
        if (query != '') {
            $.ajax({
                url: "<?php echo e(route('search-desktop')); ?>",
                type: "GET",
                data: {
                    'country': query,
                    'purpose': purpose,
    ...
    $('.countryMbl').on('keyup', function() {
        ...
        if (query != '') {
            $.ajax({
                url: "<?php echo e(route('search-mobile')); ?>",
                type: "GET",
                data: {
                    'country': query,
                    'purpose': purpose,
...
<?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>