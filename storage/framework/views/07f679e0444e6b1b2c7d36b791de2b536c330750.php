...
<?php $__env->startSection('title',$page_info.'|'.'Saakin.com'); ?>
<?php $__env->startSection('description',$page_info->page_content); ?>
<?php $__env->startSection('type','property'); ?>
<?php $__env->startSection('url',url()->current()); ?>
                ...
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h1 style="color: white">
                            <?php echo e($type->plural_name); ?> for <?php echo e(ucfirst($property_purpose)); ?> in Qatar
                        </h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row d-flex property-filter d-sm-flex col-12">
                            ...
                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-3 <?php echo e($loop->index > 7 ? 'moreLess' : ''); ?>" >
                                    <a 
                                    href="<?php echo e(route('cpt-purpose', [$buyOrRent, Str::slug($item->slug), Str::slug($type->plural) . '-for-' . strtolower($property_purpose)])); ?>"
                                            ...
                                            <select name="property_type" id="property_type"
                                                ...
                                                <?php $__currentLoopData = $propertyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($propertyType->id); ?>"
                                                        <?php echo e($type->id == $propertyType->id ? 'selected' : ''); ?>>
                                                        <?php echo e($propertyType->types); ?> (<?php echo e($propertyType->pcount); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                            ...
                            <?php if(count($properties) > 0): ?>
                                ...
                                <div class="property-filter d-sm-flex mt-10">
                                    <ul class="property-short list-unstyled d-sm-flex mb-0">
                                        <li>
                                            <form
                                                action="<?php echo e(route('property-type-purpose', [$buyOrRent, Str::slug($type->slug) . '-for-' . $property_purpose])); ?>"
                                                ...
                                                <input type="hidden" name="property" value="<?php echo e(Request::segment(2)); ?>" />
                                                    ...
                                                    <div class="short-by">
                                                        <select name="sort_by" id="sort_by"
                                                            ...
                                                            <option value="featured"
                                                                <?php echo e(request('sort_by') == 'featured' ? 'selected' : ''); ?>>
                                                                Featured
                                                            </option>
                                                            <option value="newest"
                                                                <?php echo e(request('sort_by') == 'newest' ? 'selected' : ''); ?>>
                                                                Newest
                                                            </option>
                                                            <option value="low_price"
                                                                <?php echo e(request('sort_by') == 'low_price' ? 'selected' : ''); ?>>
                                                                Price (Low)
                                                            </option>
                                                            <option value="high_price"
                                                                <?php echo e(request('sort_by') == 'high_price' ? 'selected' : ''); ?>>
                                                                Price (High)
                                                            </option>
                                                            <option value="beds_least"
                                                                <?php echo e(request('sort_by') == 'beds_least' ? 'selected' : ''); ?>>
                                                                Beds (Least)
                                                            </option>
                                                            <option value="beds_most"
                                                                <?php echo e(request('sort_by') == 'beds_most' ? 'selected' : ''); ?>>
                                                                Beds (Most)
                                                            </option>
                                                        </select>
                                                    </div>
            ...
            <div class="row pro_mobile">
                <div class="col-12 bg-white d-flex pb-2 filter-btns"
                    ...
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <a class="px-3"
                                href="<?php echo e(route('cpt-purpose', [$buyOrRent, Str::slug($item->slug), Str::slug($type->types) . '-for-' . strtolower($property_purpose)])); ?>">
            ...
            <div class="row pro_mobile">
                <div class="col-12 bg-white d-flex pb-2 filter-btns">
                    ...
                    <select name="sort_by" id="sort_by" class="ml-2 mob_sort" onchange="FormSubmit(this);">
                        <option value="featured" <?php if(isset(request()->sort_by)): ?>
                        ...
                        <option value="newest" <?php if(isset(request()->sort_by)): ?>
                        ...
                        <option value="low_price" <?php if(isset(request()->sort_by)): ?>
                        ...
                        <option value="high_price" <?php if(isset(request()->sort_by)): ?>
                        ...
                        <option value="beds_least" <?php if(isset(request()->sort_by)): ?>
                        ...
                        <option value="beds_most" <?php if(isset(request()->sort_by)): ?>
                            ...
                            <div class="row pt-2">
                                    ...
                                    <select name="property_purpose" id="property_purpose"  onchange="setPropertyPurpose(value)" class="hero__form-input  form-control mb-20">
                                        ...
                                        <?php $__currentLoopData = $propertyPurposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyPurpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($propertyPurpose->name); ?>"
                                                <?php echo e(ucfirst($property_purpose) == $propertyPurpose->name ? 'selected' : ''); ?>>
                                                <?php echo e($propertyPurpose->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mb-20">
                                    <div class="input-search">
                                        ...
                                        value="<?php echo e(Request::get('keywordMbl') ?? Request::get('keywordextra')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-20">
                                    <div class="input-search">
...
<?php echo $__env->make("front.layouts.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/pages/properties/property-type-for-purpose.blade.php ENDPATH**/ ?>