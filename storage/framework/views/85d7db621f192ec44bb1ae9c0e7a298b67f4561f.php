...
<?php $__env->startSection('description',$page_info); ?>
<?php $__env->startSection('keyword',$page_info); ?>
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h1>
                            <?php echo e($type->plural_name); ?> for <?php echo e(ucfirst($property_purpose)); ?> in <?php echo e($town->name); ?>
                        ...
                        <div class="row d-flex property-filter d-sm-flex col-12">
                            ...
                            <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-3 <?php echo e($loop->index > 7 ? 'moreLess' : ''); ?>" >
                                    <a 
                                    href="<?php echo e(route('cpt-purpose', [$buyOrRent, Str::slug($city->slug), Str::slug($type->plural) . '-for-' . strtolower($property_purpose).'-'.$subcity->slug.'-'.$town->slug.'-'.$item->slug ])); ?>"
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            <div class="sidebar-left">
                                <div class="sidebar-ad" style="background-color: red">
                            ...
                            <?php if(count($properties) > 0): ?>
                                ...
                                <div class="property-filter d-sm-flex mt-10">
                                    <ul class="property-short list-unstyled d-sm-flex mb-0">
                                        <li>
                                            <form 
                                                action="<?php echo e(route('cpt-purpose', [$buyOrRent, Str::slug($city->slug), Str::slug($type->plural) . '-for-' . strtolower($property_purpose).'-'.$subcity->slug.'-'.$town->slug ])); ?>" 
                                                name="frmSortBy" id="frmSortBy"
                                                class="form-inline form-1" 
                                                method="get"
                                            >
                                                <input type="hidden" value="<?php echo e(Request::segment(1)); ?>" name="buyOrRent">
                                                <input type="hidden" value="<?php echo e(Request::segment(2)); ?>" name="city" />
                                                <input type="hidden" value="<?php echo e(Request::segment(3)); ?>" name="property_type_purpose" />
                                                        ...
                                                        <div class="col-md-6 col-sm-12 col-4 pr-0">
                                                            <div class="property-item">
                                                                <a class="property-img"
                                                                    href="<?php echo e(route('property-detail', [strtolower($property->property_purpose), $property->property_slug, $property->id])); ?>"
...
<?php echo $__env->make("front.layouts.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/pages/properties/town-property-type-for-purpose.blade.php ENDPATH**/ ?>