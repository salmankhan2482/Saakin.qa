...
<div class="hero v2 section-padding" style="background-image: url('<?php echo e('assets/images/backgrounds/bg-7.jpg'); ?>')">
    ...
    <div class="container pos-abs">
        <div class="row">
            ...
            <div class="col-md-10  ml-auto mr-auto desktop">
                <form action="<?php echo e(url('properties')); ?>" class="hero__form v2 filter listing-filter bg-cb" method="get"
                        ...
                        <div class="col-md-2 col-12">
                            <select name="property_type" class="hero__form-input form-control custom-select" onchange="setPropertyType(this)">
                                ...
                                <?php $__currentLoopData = $propertyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($propertyType->id); ?>"><?php echo e($propertyType->types); ?></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" name="keywordMbl" class="countryMbl" id="countryMbl" placeholder="Search Location" value="<?php echo e(Request::get('keywordMbl')); ?>" autocomplete="off" style="padding: 4px 15px 4px 10px !important;">
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/pages/include/search.blade.php ENDPATH**/ ?>