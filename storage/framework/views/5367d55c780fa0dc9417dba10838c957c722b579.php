            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h1>
                            <?php echo e($type->plural_name); ?> for <?php echo e(ucfirst($property_purpose)); ?> in <?php echo e($area->name); ?>
                            ...
                            <?php if(count($properties) > 0): ?>
                                ...
                                <div class="property-filter d-sm-flex mt-10">
                                    <ul class="property-short list-unstyled d-sm-flex mb-0">
                                        <li>
                                            <form 
                                                action="<?php echo e(route('cpt-purpose', [$buyOrRent, Str::slug($city->slug), Str::slug($type->types) . 's-for-' . strtolower($property_purpose).'-'.$subcity->slug.'-'.$town->slug.'-'.$area->slug ])); ?>" 
...
<?php echo $__env->make("front.layouts.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp 7.4\htdocs\saakin\resources\views/front/pages/properties/area-property-type-for-purpose.blade.php ENDPATH**/ ?>