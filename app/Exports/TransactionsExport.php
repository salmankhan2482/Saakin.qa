...
class TransactionsExport implements FromCollection, WithHeadings, ShouldAutoSize , WithEvents, WithMapping
{
    ...
    {
        return Transactions::orderBy('id')->get(['id','user_id','email','plan_id','gateway','payment_amount','tax_amount','total_payment_amount','payment_id','date']);
    }
