...
class TypesController extends MainAdminController
{
   public function __construct()
   {
      ...
      $this->middleware('permission:properties-type-list', ['only' => ['index']]);
      $this->middleware('permission:properties-type-create', ['only' => ['create','store']]);
      $this->middleware('permission:properties-type-edit', ['only' => ['edit','update']]);
      $this->middleware('permission:properties-type-delete', ['only' => ['destroy']]);
      parent::__construct();
   }
