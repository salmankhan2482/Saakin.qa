...
class BlogController extends Controller
{
   public function __construct()
   {
      ...
      $this->middleware('permission:blog-edit', ['only' => ['edit','update','status']]);
      $this->middleware('permission:blog-delete', ['only' => ['destroy']]);
      $this->middleware('permission:blog-category-list', ['only' => ['listBlogCategory']]);
      $this->middleware('permission:blog-category-create', ['only' => ['createBlogCategory','storeBlogCategory']]);
      $this->middleware('permission:blog-category-edit', ['only' => ['editBlogCategory','updateBlogCategory']]);
      $this->middleware('permission:blog-category-delete', ['only' => ['destroyBlogCategory']]);
