...
class CityGuideController extends Controller
{
   public function __construct()
   {
      ...
      $this->middleware('permission:city-guide-list', ['only' => ['index','listCityDetail']]);
      $this->middleware('permission:city-guide-create', ['only' => ['create','store','createCityDetail','storeCityDetail']]);
      $this->middleware('permission:city-guide-edit', ['only' => ['edit','update','editCityDetail','updateCityDetail']]);
      $this->middleware('permission:city-guide-delete', ['only' => ['destroy','destroyCityDetail']]);
   }
