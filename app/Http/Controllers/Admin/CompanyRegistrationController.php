...
class CompanyRegistrationController extends MainAdminController
{
   public function __construct()
   {
      ...
      $this->middleware('permission:company-registration-list', ['only' => ['index']]);
      $this->middleware('permission:company-registration-create', ['only' => ['create','store']]);
      $this->middleware('permission:company-registration-edit', ['only' => ['edit','update']]);
      $this->middleware('permission:company-registration-delete', ['only' => ['destroy']]);
   }
