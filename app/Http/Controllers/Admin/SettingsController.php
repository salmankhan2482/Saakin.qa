...
class SettingsController extends MainAdminController
{
   public function __construct()
   {
      ...
      $this->middleware('permission:settings-list', ['only' => ['settings']]);
      $this->middleware('permission:settings-edit', ['only' => ['settingsUpdates','layout_settings_update','smtp_email_update','payment_info_update', 'social_links_update', 'addthisdisqus', 'contact_us_page', 'headfootupdate']]);
   }
