  ...
  <div class="container">
    ...
    @if ((new \Jenssegers\Agent\Agent())->isMobile())
      ...
      <h5 class="title text-white mb-0 pb-3 fw-500 d-flex align-item-center justify-content-between" data-bs-toggle="collapse" data-bs-target="#footer_widget4" aria-expanded="false"
        ...
        {{ getcong('footer_widget4_title') }} <i class="fas fa-caret-down"></i>
      </h5>
      ...
      <h5 class="title text-white mb-0 pb-3 fw-500 d-flex align-item-center justify-content-between" data-bs-toggle="collapse" data-bs-target="#footer_widget5" aria-expanded="false" aria-controls="footer_widget5">
        Get in Touch
        <i class="fas fa-caret-down"></i>
      </h5>
      <div class="collapse" id="footer_widget5">
        <ul class="footer-links mt-0">
