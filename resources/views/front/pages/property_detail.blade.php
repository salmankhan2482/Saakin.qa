...
$whatsapText = 'Hello,
I would like to inquire about this property posted on saakin.qa
    ...
    <div class="inner-content">
        ...
        <div class="container">
            ...
            <div class="position-relative">
                <div class="gallery_btn position-absolute bottom-0 start-0 p-3 d-none d-md-block @if ((new \Jenssegers\Agent\Agent())->isMobile()) mb-3 @endif"
                    style="z-index: 1;">
                    <a href="javascript:void(0)" data-fancybox-trigger="gallery" data-fancybox-index="0"
                        class="btn btn-sm btn-primary">
                        View Gallery
                    </a>
                    <a class="googleMapPopUp btn btn-sm btn-info" rel="nofollow" data-fancybox data-type="iframe"
                    ...
                    <div class="list-details-wrap">
                        <div class="d-sm-none pb-4 text-center">
                            ...
                            <div class="btn-group btn-group-sm d-flex share-btns" role="group" aria-label="Share Link">
                                ...
                                <button type="button" class="btn btn-monochrome" data-bs-toggle="modal"
                        ...
                        <h6 class="text-primary">
                            ...
                            @if (isset($property->propertyArea->name))
                                ...
                                <a
                                    href="{{ route('cpt-purpose', [$buyOrRent, Str::slug($property->propertyCity->name), Str::slug($property->propertiesTypes->plural) . '-for-' . strtolower($property->property_purpose) . '-' . Str::slug($property->propertySubcity->name) . '-' . Str::slug($property->propertyTown->name) . '-' . Str::slug($property->propertyArea->name)]) }}">
                            ...
                            @elseif (isset($property->propertyTown->name))
                                <a
                                    href="{{ route('cpt-purpose', [$buyOrRent, Str::slug($property->propertyCity->name), Str::slug($property->propertiesTypes->plural) . '-for-' . strtolower($property->property_purpose) . '-' . Str::slug($property->propertySubcity->name) . '-' . Str::slug($property->propertyTown->name)]) }}">
                            ...
                            @elseif (isset($property->propertySubcity->name))
                                <a
                                    href="{{ route('cpt-purpose', [$buyOrRent, Str::slug($property->propertyCity->name), Str::slug($property->propertiesTypes->plural) . '-for-' . strtolower($property->property_purpose) . '-' . Str::slug($property->propertySubcity->name)]) }}">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-3 position-relative rounded-img" style="min-width: 120px;">
                                    ...
                                    <div class="map_btn position-absolute bottom-0  start-50 translate-middle-x pb-2">
                                        <a data-fancybox data-type="iframe" data-preload="false" data-width="640"
                                            data-height="480"
                                        ...
                                        @if (!empty($property->agent_picture))
                                            ...
                                            <a class="d-block"
                                                ...
                                                <img src="{{ asset('upload/properties/' . $property->agent_picture) }}"
                                                    alt="{{ $property->agent_name }}" width="120">
                                            </a>
                                        @else
                                            ...
                                            <div>
                                                ...
                                                <a
                                                    ...
                                                    <img src="{{ asset('upload/agencies/' . $agency->image) }}"
                                                        class="rounded-circle" alt="{{ $property->agent_name }}"
                                                        width="50">
                                                </a>
                                            </div>
                                            <div>
                                                ...
                                                <a class="link-dark text-decoration-none fw-bold"
                                                    href="{{ route('agency_detail', [Str::slug($agency->name), $agency->id]) }}">
                                                    ({{ App\Properties::where('status', '1')->where('agency_id', $agency->id)->count() }}
                                                    Properties)
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="card-body text-center shadow">
                        <div class="callgroup text-center justify-content-center d-flex">
                            @if (!empty($property->whatsapp))
                                <a href="tel:{{ $property->whatsapp }}"
                                    ...
                                    data-property_id={{ $property->id }} data-agency_id={{ $property->agency_id }}
                            ...
                            @if (!empty($property->whatsapp))
                                <a href="//api.whatsapp.com/send?phone={{ $property->whatsapp }}&text={{ urlencode($whatsapText) }}"
                                    class="btn btn-sm btn-success me-1 btnCount" data-property_id={{ $property->id }}
                            ...
                            @endif
                            <button class="btn btn-danger btn-sm btnCount" type="button"
                                data-property_id={{ $property->id }} data-agency_id={{ $property->agency_id }}
                                data-button_name='Email' data-bs-toggle="modal" data-bs-target="#emailAgentModal"
                                id="emailBtn"
                        ...
                        <div class="call-detail-block">
                            <div class="num-btn-holder">
                                ...
                                <a class="btn-email btnCount" id="emailBtn" data-property_id={{ $property->id }}
                    ...
                    <div class="d-flex flex-wrap align-items-center spbwx12 spbwy8">
                        ...
                        <div>
                            <a href="http://www.facebook.com/sharer.php?u={{ url()->current() }}"
                                class="btn btn-monochrome btn-sm share-btn">
                        ...
                        <div>
                            <button class="btn btn-monochrome btn-sm share-btn popup" value="copy"
                                style="background: none !important"
                                onclick="copyToClipboard('copy_{{ $property->id }}')">

                                <span class="popuptext mypopup" id="copy">copied!</span>
                                <img src="{{ asset('upload/copy-icon.png') }}" style="height: 1rem"
                                    class="social" alt="Copy URL">
                                Copy Link
                            </button>
                        </div>
                        <div>
                ...
                <div class="card sticky-lg-top call-email-block" tabindex="1">
                    <div class="card-body">
                        ...
                        <div class="callgroup text-center justify-content-center">
                            @if (!empty($property->whatsapp))
                                <a href="tel:{{ $property->whatsapp }}" class="btn btn-primary btn-call btnCount"
                            ...
                            @else
                                <a href="tel:{{ $agency->phone }}" class="btn btn-primary btn-call btnCount"
                                    data-property_id={{ $property->id }}
                                    data-agency_id={{ $property->agency_id }} data-button_name='Call'>
                                    <i class="fas fa-phone-alt"></i>
                                    Call Now
                            ...
                            @if (!empty($property->whatsapp))
                                <a href="//api.whatsapp.com/send?phone={{ $property->whatsapp }}&text={{ urlencode($whatsapText) }}"
                                    class="btn btn-success btnCount" data-property_id={{ $property->id }}
                                    data-agency_id={{ $property->agency_id }} data-button_name='WhatsApp'>
                                    <i class="fab fa-whatsapp"></i>
                                    WhatsApp
                                </a>
                            ...
                            @endif
                            <button class="btn btn-danger btnCount" type="button"
                                data-property_id={{ $property->id }} data-agency_id={{ $property->agency_id }}
                                data-button_name='Email' data-bs-toggle="modal" data-bs-target="#emailAgentModal"
                                id="emailBtn"
                                data-image="{{ asset('upload/properties/' . $property->featured_image) }}"
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2421573832685297"
                            data-ad-slot="4096007508" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>
                    ...
                    @foreach ($properties as $propx)
                        <div class="single-property-box border">
                            <div class="property-item">
                                <a style="--img-container-height: 155px" class="property-img stretched-link"
                                    href="{{ url(strtolower($property->property_purpose) . '/' . $propx->property_slug . '/' . $propx->id) }}" target="_blank">
