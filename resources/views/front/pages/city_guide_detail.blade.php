...
@section('content')
    ...
    <div class="site-banner"
        style="background-image: url({{ asset('upload/cities/' . $cityGuide->city_image) }}); background-position: center;">
        <div class="container">
    ...
    <div class="inner-content">
        <div class="container">
            ...
            <ul id="cityGideNav"
                class="cityGideNav list-unstyled spbwx16 can-scroll-x d-flex sticky-top bg-white justify-content-md-center py-2 mb-3 border-bottom">
                <li>
            ...
            <div class="fs-sm">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="propertyTrends">
                            <button class="accordion-button collapsed p-3 rounded bg-dark" style="--bs-bg-opacity:.05;"
                                type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne"
                                aria-expanded="false" aria-controls="flush-collapseOne">
                                Property Trends
                            </button>
                        </h2>
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="propertyTrends"
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="google-ad mb-4">
                                    ...
                                    <ins class="adsbygoogle" style="display:block; text-align:center;"
                                        ...
                                        data-ad-client="ca-pub-2421573832685297" data-ad-slot="7852560352"></ins>
                                    <script>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="neighborhood"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                {!! $cityGuideContent->neighborhood ?? '' !!}<br>
                                <div class="p-2 border mb-3">
                                    <iframe class="d-block" src="{{ $cityGuide->map ?? '' }}" width="100%"
                                        height="450" allowfullscreen="" loading="lazy"
                                        referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                                <div
                                    class="mb-3 @if ((new \Jenssegers\Agent\Agent())->isMobile()) pro-same-m d-flex can-scroll-x spbwx16 @else pro-same-slider @endif">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="lifestyle"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="thingsToConsider">
                            <button class="accordion-button collapsed p-3 rounded bg-dark" style="--bs-bg-opacity:.05;"
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="thingsToConsider"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="locations">
                            <button class="accordion-button collapsed p-3 rounded bg-dark" style="--bs-bg-opacity:.05;"
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="locations"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="attributes"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
...
@push('scripts')
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0"
        style="display:none;">
        <symbol id="address-location" x="0px" y="0px" viewBox="0 0 122.88 117.55"
            style="enable-background:new 0 0 122.88 117.55" xml:space="preserve">
            <style type="text/css">
                .st0 {
                    fill-rule: evenodd;
                    clip-rule: evenodd;
        ...
        <symbol id="home-location" x="0px" y="0px" viewBox="0 0 92.26 122.88" style="enable-background:new 0 0 92.26 122.88"
            xml:space="preserve">
            <style type="text/css">
                .st0 {
                    fill-rule: evenodd;
        ...
        <symbol id="life-style" x="0px" y="0px" viewBox="0 0 122.88 94.15" style="enable-background:new 0 0 122.88 94.15"
            xml:space="preserve">
            <g>
                <path
        ...
        <symbol id="town-city" x="0px" y="0px" viewBox="0 0 122.88 86.59" style="enable-background:new 0 0 122.88 86.59"
            xml:space="preserve">
            <g>
                <path
