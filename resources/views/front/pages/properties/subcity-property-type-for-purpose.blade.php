                ...
                <div class="short-wrap mb-3">
                    ...
                    @if ((new \Jenssegers\Agent\Agent())->isMobile())
                        <div class="row gx-2 mb-3">
                            ...
                            <div class="col">
                                <form action="{{ route('cpt-purpose', [$buyOrRent,Str::slug($city->slug),Str::slug($type->plural) . '-for-' . strtolower($property_purpose) . '-' . $subcity->slug]) }}" name="frmSortBy"  id="frmSortBy" class="form-inline form-1" method="get" >
                ...
                <div class="location-wrap">
                    @foreach ($towns as $item)
                        <div class="location-item {{ $loop->index > 7 ? 'moreLess' : '' }}">
                            ...
                            <a href="{{ route('cpt-purpose', [$buyOrRent,Str::slug($city->slug),Str::slug($type->plural) . '-for-' . strtolower($property_purpose) . '-' . $subcity->slug . '-' . $item->slug]) }}" >
