            ...
            @if (count($properties) > 0)
                ...
                <div class="short-wrap mb-3">
                    ...
                    @if ((new \Jenssegers\Agent\Agent())->isMobile())
                        ...
                        <form action="{{ route('cpt-purpose', [$buyOrRent,Str::slug($city_keyword->slug),Str::slug($type->plural) . '-for-' . strtolower($property_purpose) . '-' . $subcity_keyword->slug . '-' . $town_keyword->slug]) }}" method="get" >
                ...
                <div class="location-wrap">
                    @foreach ($areas as $item)
                        <div class="location-item {{ $loop->index > 7 ? 'moreLess' : '' }}">
                            ...
                            <a  href="{{ route('cpt-purpose', [$buyOrRent,Str::slug($city_keyword->slug),Str::slug($type->plural) .'-for-' .strtolower($property_purpose) .'-' .$subcity_keyword->slug .'-' .$town_keyword->slug .'-' .$item->slug]) }}" >
                        ...
                        <div class="list-sidebar mt-3 mt-lg-0">
                            ...
                            <div class="sidebar-links p-3">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ url("properties?city=$item->property_cities_id&subcity=$item->property_sub_cities_id&town=$item->id&property_purpose=$property_purpose&property_type=$type->id") }}">
