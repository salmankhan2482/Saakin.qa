                        ...
                        <div class="list-sidebar mt-3 mt-lg-0">
                            ...
                            <div class="sidebar-links p-3">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('cpt-purpose', [$buyOrRent,Str::slug($city_keyword->slug),Str::slug($type->plural) . '-for-' . strtolower($property_purpose) . '-' . $subcity_keyword->slug . '-' . Str::slug($item->name)]) }}">
