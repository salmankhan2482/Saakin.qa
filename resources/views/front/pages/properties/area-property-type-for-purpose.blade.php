            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h1>
                            {{$type->plural_name}} for {{ucfirst($property_purpose) }} in {{$area->name}}
                        </h1>
                        <span>
                        ...
                        <span>
                            <a href="{{ route('cpt-purpose', [$buyOrRent, $city->slug, $type->plural . '-for-' . strtolower($property_purpose).'-'.$subcity->slug.'-'.$town->slug ]) }}">
                                {{ $town->name }}
                            </a>
                        </span>
                        <span>{{ $area->name }}</span>
                            ...
                            @if (count($properties) > 0)
                                ...
                                <div class="property-filter d-sm-flex mt-10">
                                    <ul class="property-short list-unstyled d-sm-flex mb-0">
                                        <li>
                                            <form 
                                                action="{{ route('cpt-purpose', [$buyOrRent, Str::slug($city->slug), Str::slug($type->types) . 's-for-' . strtolower($property_purpose).'-'.$subcity->slug.'-'.$town->slug.'-'.$area->slug ]) }}" 
