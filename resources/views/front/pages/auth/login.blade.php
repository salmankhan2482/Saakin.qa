...
@section("content")
    <div class="breadcrumb-section page-title bg-h"
         style="background-image: url('{{asset('assets/images/citys/9.jpg')}}'); background-position: bottom">
                                                        ...
                                                        <div class="col-md-12 text-right">
                                                            <div class="res-box sm-left">
                                                                <a href="{{ route('password.email') }}"
                                                                    tabindex="5"
                                                                    class="forgot-password">{{ trans('words.forgot_password') }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="res-box text-center mt-30">
                                                        <button type="submit" class="btn v8"><span
                                                                class="lnr lnr-exit"></span>
                                        ...
                                        <div class="tab-pane fade" id="register" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="res-box text-center mt-30">
                                                        <button type="submit" class="btn v8"><i
                                                                class="lnr lnr-enter"></i>{{ 'Create an account' }}</button>
                                                    </div>
                                                    </form>
                                                </div>
