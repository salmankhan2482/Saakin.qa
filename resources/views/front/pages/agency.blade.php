            ...
            <div class="col-md-12" style="display: flex">
                ...
                <div class="col-md-6">
                    <form method="GET" action="{{route('agency_detail', [Str::slug($agency->name), $agency->id])}}" id="sortForm">
                        <div class="col-md-6 d-flex justify-content-end" style="float: right; width: 100%; margin-top: 10px;">

                            <select  name="sortSelect" class="agency-select" onchange="FormSubmit(this);"  >
