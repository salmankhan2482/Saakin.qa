...
@section('content')
  <div class="breadcrumb-section page-title bg-h" style="background-image: url('{{ asset('assets/images/backgrounds/bg-4.jpg') }}')">
                  ...
                  <div class="tab-pane fade" id="login" role="tabpanel">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        {!! Form::open(['url' => 'login', 'class' => 'search-form', 'id' => 'loginform', 'role' => 'form']) !!}
                        @csrf
                        <div class="form-group">
