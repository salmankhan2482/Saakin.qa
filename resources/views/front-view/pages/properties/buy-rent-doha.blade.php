    ...
    <div class="row">
      <div class="col-md-8 offset-md-2 text-center">
        <div class="breadcrumb-menu">
          <h1> Properties for {{ucfirst($property_purpose)}} in {{ $city }} </h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-12">
        <div class="property-filter d-sm-flex mt-10">
          <div class="row d-flex property-filter d-sm-flex ">
            ...
            <div class="col-3">
              @if (ucfirst($property_purpose) == 'Sale')
              <a
                href="{{ route('property-type-purpose',['buy', Str::slug($propertyType->slug) . '-for-'.strtolower($property_purpose)]) }}">
                <span style="color: #009FFF"> {{ $propertyType->types }} </span>
                ({{ $propertyType->pcount }})
              </a>
              @else
              <a
                href="{{ route('property-type-purpose',['rent', Str::slug($propertyType->slug) . '-for-'.strtolower($property_purpose)]) }}">
                <span style="color: #009FFF"> {{ $propertyType->types }} </span>
                ({{ $propertyType->pcount }})
              </a>
              @endif
        ...
        <div class="sidebar-left" style="padding-top: 0px !important; margin-top: 10px;">
          <div class="widget filter-widget">
            ...
            <div class="widget-title widget-collapse">
              ...
              <a id="colhide" class="ml-auto" data-toggle="collapse" href="#filter-property" role="button"
                aria-expanded="true" aria-controls="filter-property"> <i class="fas fa-chevron-down"></i> </a>
            </div>
            ...
            <div class="collapse show" id="filter-property" style="">
              <form action="{{ url('properties') }}" class="hero__form v2 filter" method="get">
                ...
                <div class="row">
                  ...
                  <div class="col-12 mb-3">
                    <select name="property_type" id="property_type" class="hero__form-input form-control custom-select"
                  ...
                  <div class="col-xl-6 col-12 mb-3">
                    <select name="bedrooms" id="bedrooms" class="hero__form-input  form-control custom-select">
                  ...
                  <div class="col-xl-6 col-12 mb-3">
                    <select name="bathrooms" id="bathrooms" class="hero__form-input  form-control custom-select">
                  ...
                  <div class="col-12 mb-3">
                    <div class="input-search">
                      <input type="text" class="typeahead" name="keyword" id="country" placeholder="Search Location"
          ...
          <div class="col-12">
            ...
            <div class="property-filter d-sm-flex mt-10">
              <ul class="property-short list-unstyled d-sm-flex mb-0">
                <li>
                  <form action="{{ route('buyRent-doha', [strtolower($property_purpose.'/'.$city)]) }}" name="frmSortBy"
                    id="frmSortBy" class="form-inline form-1" method="get">
                    <input type="hidden" name="buyOrRent" value="{{ strtolower($property_purpose) }}" />

                    <input type="hidden" name="doha" value="{{ strtolower($city) }}" />

                    <div class="form-group d-lg-flex d-block">
                      <label class="justify-content-start">Sort by:</label>
                      <div class="short-by">
                        <select name="sort_by" id="sort_by" class="hero__form-input form-control custom-select"
              ...
              <ul class="property-view-list nav item-filter-list list-unstyled d-flex mb-0 waqas" role="tablist">
                      ...
                      <div class="col-md-6 col-sm-12 col-4 pr-0">
                        <div class="property-item">
                          <a class="property-img"
                            ...
                            @else
                            <img src="{{ asset('assets/images/no-img.png') }}" alt="{{$property->property_name}}">
                            @endif
                          </a>
                            ...
                            <a class="trend-right float-right">
                              <div class="trend-open">
                                <p><span class="per_sale">starts
                                  ...
                                  @if ($property->property_purpose == 'For Rent' || $property->property_purpose ==
                                  'Rent')
                                  / Month
                                  @endif
                                </p>
      ...
      <div id="mySidebar" class="searchbar">
        ...
        <div class="container">
          <form action="{{ url('properties') }}" method="get">
            ...
            <div class="row pt-2">
              <div class="col-md-12">
                <select name="property_purpose" id="property_purpose" onchange="setPropertyPurpose(value)"
                  class="hero__form-input  form-control mb-20">
                  <option value="" selected>Property Purpose</option>
                  @foreach ($propertyPurposes as $propertyPurpose)
                  <option value="{{ $propertyPurpose->name }}" {{ Str::ucfirst($property_purpose)==$propertyPurpose->
                    name ? 'selected' : '' }}>
                    {{ $propertyPurpose->name }}
                  </option>
                  @endforeach
              ...
              <div class="offset-3 col-md-6 col-6"><button type="submit" class="btn btn-block v3">Search</button></div>
            </div>
          </form>
        </div>
      </div>
        ...
        <div class="card-list featured_mobile">
          <div class="card-list__item mt-2">
            <div class="property-card__section">
              ...
              $propertyUrl = url(strtolower($property->property_purpose) . '/' . $property->property_slug . '/' .
              $property->id);
              $whatsapText = 'Hello,
              ...
              <div class="property-card__content">
                ...
                <div class="property-card__actions mt-0">
                  @if ($phone != '#')
                  <a class="btn btn-outline-success call_btn" href="tel:{{ $phone }}">
                  ...
                  <a class="btn btn-outline-success call_btn" id="emailBtn" href="mailto:{{ $agency->email }}"
                    ...
                    data-bedroom="{{ $property->bedrooms ?? '' }}" data-bathroom="{{ $property->bathrooms ?? '' }}"
