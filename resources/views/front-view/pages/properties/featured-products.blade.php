            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h2 style="font-family: Open Sans,sans-serif;;">Featured Properties</h2>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="input-search">
                                                <input 
                                                    type="text" class="typeahead" name="keyword" id="keyword"
                                                ...
                                                <div class="form-group d-lg-flex d-block">
                                                    ...
                                                    <div class="short-by">
                                                        <select name="sort_by" id="sort_by"
                                                            ...
                                                            <option value="low_price">Price
                                                                (Low)
                                                            </option>
                                                            <option value="high_price">Price
                                                                (High)
                                                            </option>
                                                            <option value="beds_least">Beds
                                                                (Least)
                                                            </option>
                                                            <option value="beds_most">Beds
                                                                (Most)
                                                            </option>
                                                        </select>
                                                    </div>
                ...
                <div id="mySidebar" class="searchbar">
                    ...
                    <div class="container">
                        <form action="{{ url('properties') }}" method="get">
                            ...
                            <div class="row pt-2">
                                <div class="col-md-12">
                                    <select name="property_purpose" class="hero__form-input  form-control mb-20">
                                        <option value="" selected>Property Purpose</option>
                                        @foreach ($propertyPurposes as $propertyPurpose)
                                            <option value="{{ $propertyPurpose->name }}"
                                                >
                                ...
                                <div class="col-md-12 mb-20">
                                    <div class="input-search">
                                        <input 
                                            type="text" name="keywordMbl" id="keywordMbl" 
