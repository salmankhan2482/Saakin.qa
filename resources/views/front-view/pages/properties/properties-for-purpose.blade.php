...
@section('title',$landing_page_content->title.'|'.'Saakin.com')
            ...
            <div class="col-md-8 offset-md-2 text-center">
                <div class="breadcrumb-menu">
                    <h1 style="color: white">
                        Properties for {{ucfirst($property_purpose)}} in Qatar
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="property-filter d-sm-flex mt-10">
                    <div class="row d-flex property-filter d-sm-flex ">
                        ...
                        <div class="col-3 {{ $loop->index > 7 ? 'moreLess' : ''}}">
                            ...
                            <a
                                href="{{ route('property-type-purpose',['buy', Str::slug($propertyType->slug) . '-for-'.$property_purpose]) }}">
                                <span style="color: #009FFF"> {{ $propertyType->types }} </span>
                                ({{ $propertyType->pcount }})
                            </a>
                            @else
                            <a
                                href="{{ route('property-type-purpose',['rent', Str::slug($propertyType->slug) . '-for-'.$property_purpose]) }}">
                                <span style="color: #009FFF"> {{ $propertyType->types }} </span>
                                ({{ $propertyType->pcount }})
                            </a>
                            @endif
                    ...
                    <div class="widget filter-widget">
                        ...
                        <div class="widget-title widget-collapse">
                            ...
                            <a id="colhide" class="ml-auto" data-toggle="collapse" href="#filter-property" role="button"
                                aria-expanded="true" aria-controls="filter-property"> <i
                        ...
                        <div class="sidebar-left">
                            <div class="sidebar-ad">
                                ...
                                <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2421573832685297"
                                    data-ad-slot="6760164139" data-ad-format="auto"
                        ...
                        <div class="property-filter d-sm-flex mt-10">
                            <ul class="property-short list-unstyled d-sm-flex mb-0">
                                <li>
                                    ...
                                    <form action="{{ route('property-purpose', [$buyOrRent, $property_purpose]) }}"
                                        ...
                                        <input type="hidden" name="property_purpose"
                                            value="{{ Str::substr(Request::segment(2), -4) }}" />
                                        ...
                                        <div class="form-group d-lg-flex d-block">
                                            ...
                                            <div class="short-by">
                                                <select name="sort_by" id="sort_by"
                                                    ...
                                                    <option value="featured" {{ request('sort_by')=='featured'
                                                        ? 'selected' : '' }}>
                                                        Featured
                                                    </option>
                                                    ...
                                                    <option value="low_price" {{ request('sort_by')=='low_price'
                                                        ? 'selected' : '' }}>
                                                        Price (Low)
                                                    </option>
                                                    <option value="high_price" {{ request('sort_by')=='high_price'
                                                        ? 'selected' : '' }}>
                                                        Price (High)
                                                    </option>
                                                    <option value="beds_least" {{ request('sort_by')=='beds_least'
                                                        ? 'selected' : '' }}>
                                                        Beds (Least)
                                                    </option>
                                                    <option value="beds_most" {{ request('sort_by')=='beds_most'
                                                        ? 'selected' : '' }}>
                                                        Beds (Most)
                                                    </option>
                                                </select>
                    ...
                    <form action="{{ url('properties') }}" method="get">
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col-md-12 mb-20">
                                <div class="input-search">
                                    <input type="text" class="typeahead countryMbl" name="keywordextra"
                                        id="keywordextra" placeholder="View of Water, Gym, or Security"
