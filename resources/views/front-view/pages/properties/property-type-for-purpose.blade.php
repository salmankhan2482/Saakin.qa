...
@section('title',$page_info.'|'.'Saakin.com')
      ...
      <div class="col-md-8 offset-md-2 text-center">
        <div class="breadcrumb-menu">
          <h1 style="color: white">
            {{ $type->types }}s for {{ ucfirst($property_purpose) }} in Qatar
          </h1>
        </div>
      </div>
    </div>
        ...
        <div class="property-filter d-sm-flex mt-10 col-12">
          <div class="row d-flex property-filter d-sm-flex col-12">
            ...
            <div class="col-3 {{ $loop->index > 7 ? 'moreLess' : ''}}">
              <a href="{{ route('cpt-purpose', [$buyOrRent, Str::slug($item->slug), Str::slug($type->types) . '-for-' . strtolower($property_purpose)]) }}"
                ...
                <div class="row">
                  ...
                  <div class="col-12 mb-3">
                    <select name="property_type" id="property_type" class="hero__form-input form-control custom-select"
                      ...
                      <option value="{{ $propertyType->id }}" {{ $type->id == $propertyType->id ?
                        'selected' : '' }}>
          ...
          <div class="col-md-12">
            <div class="sidebar-left">
              <div class="sidebar-ad">
                <script async
                  src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2421573832685297"
                  crossorigin="anonymous"></script>
                <!-- side bar -->
                <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2421573832685297"
                  data-ad-slot="6760164139" data-ad-format="auto" data-full-width-responsive="true"></ins>
                <script>
              ...
              <ul class="property-short list-unstyled d-sm-flex mb-0">
                <li>
                  <form
                    ...
                    <input type="hidden" name="buyOrRent" value="{{ Request::segment(1) }}" />
            ...
            <div class="row pt-2">
              <div class="col-md-12">
                <select name="property_purpose" id="property_purpose" onchange="setPropertyPurpose(value)"
                  ...
                  <option value="" selected>Property Purpose</option>
                  @foreach ($propertyPurposes as $propertyPurpose)
                  <option value="{{ $propertyPurpose->name }}" {{ ucfirst($property_purpose)==$propertyPurpose->name ?
                    'selected' : '' }}>
              ...
              <div class="col-md-12 mb-20">
                <div class="input-search">
                  <input type="text" class="typeahead countryMbl" name="keywordextra" id="keywordextra"
