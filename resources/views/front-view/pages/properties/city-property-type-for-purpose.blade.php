            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="breadcrumb-menu">
                        <h1>
                            {{$type->types}}s for {{ucfirst($property_purpose) }} in {{$city->address}}
                        </h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row d-flex property-filter d-sm-flex col-12">
                            ...
                            @foreach ($subcities as $item)
                                <div class="col-3 {{ $loop->index > 7 ? 'moreLess' : ''}}" >
                                    <a 
                                    href="{{ route('cptp-subcity', [$buyOrRent, Str::slug($city->slug), Str::slug($type->types).'-for-'.strtolower($property_purpose), '-'.$item->slug ]) }}"
                            ...
                            @if (count($properties) > 0)
                                ...
                                <div class="property-filter d-sm-flex mt-10">
                                    <ul class="property-short list-unstyled d-sm-flex mb-0">
                                        <li>
                                            <form 
                                                action="{{ route('cpt-purpose', [$buyOrRent, Str::slug($city->address), Str::slug($type->types) . '-for-' . strtolower($property_purpose)])}}" 
