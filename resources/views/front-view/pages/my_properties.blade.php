                                ...
                                @foreach ($propertieslist as $i => $property)
                                    <tr>
                                        ...
                                        <td class="property-title">
                                            <a
                                                href="{{ url('properties/' . $property->property_slug . '/' . Crypt::encryptString($property->id)) }}">
                                            ...
                                            <p>
                                                <strong>{{ $property->getPrice() }}</strong>
                                            </p>
                                        </td>
                                        ...
                                        <td class="property-actions">
                                            <a href="{{ url('properties/' . $property->property_slug . '/' . $property->id) }}"
                                                target="_blank"><i class="fa fa-eye icon"></i>{{ trans('words.view') }}</a>
                                            <a href="{{ url('update-property/' . Crypt::encryptString($property->id)) }}"><i
