...
@section('content')
  ...
  <div class="inner-content">
    <div class="container">
      ...
      <nav id="cityGideNav" class="cityGideNav d-flex sticky-top bg-white justify-content-center py-2 mb-3 border-bottom">
        <a class="nav-link" href="#guidePropertyTrends">Property Trends</a>
        <a class="nav-link" href="#guideNeighborHood">NeighborHood</a>
        <a class="nav-link" href="#guideLifeStyle">Life Style</a>
        <a class="nav-link" href="#guideThingsToConsider">Things To Consider</a>
        <a class="nav-link" href="#guideLocations">Locations</a>
        <a class="nav-link" href="#guideAttributes">Attributes</a>
      </nav>
      <div data-bs-spy="scroll" data-bs-target="#cityGideNav" data-bs-offset="100" tabindex="0">
        ...
        <div class="container d-flex icons-container">
          <ul>
            <li class="li-fixed" onclick="toScroll('propertyTrends');">
              <div class="propertyTrendsDiv" style="background: url(/assets/images/cityGuide/propertyTrends.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
            ...
            <li class="li-fixed" onclick="toScroll('neighborhood');">
              <div class="neighborhoodDiv" style="background: url(/assets/images/cityGuide/neighborHood.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
            ...
            <li class="li-fixed" onclick="toScroll('lifestyle');">
              <div class="lifestyleDiv" style="background: url(/assets/images/cityGuide/lifeStyle.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
            ...
            <li class="li-fixed" onclick="toScroll('thingsToConsider');">
              <div class="thingsToConsiderDiv" style="background: url(/assets/images/cityGuide/thingsToConsider.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
            ...
            <li class="li-fixed" onclick="toScroll('locations');">
              <div class="locationsDiv" style="background: url(/assets/images/cityGuide/locations.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
            ...
            <li class="li-fixed" onclick="toScroll('attributes');">
              <div class="attributesDiv" style="background: url(/assets/images/cityGuide/attributes.png) no-repeat 50% 50%; background-size: auto 100%; height: 50px; ">
                &nbsp;
              </div>
              <div>
        ...
        @foreach ($cityGuideDetails as $i => $cityGuideDetail)
          ...
          <div class="row mb-4">
            <div class="col-md-6 text-center mt-4">
              <img src="{{ asset('upload/cities/' . $cityGuideDetail->image1) }}" alt="{{ $cityGuide->name }}" class="guide img-fluid">
            </div>
            <div class="col-md-6 text-center mt-4">
              <img src="{{ asset('upload/cities/' . $cityGuideDetail->image2) }}" alt="{{ $cityGuide->name }}" class="guide img-fluid">
            </div>
            <div class="col-md-6 text-center mt-4">
              <img src="{{ asset('upload/cities/' . $cityGuideDetail->image3) }}" alt="{{ $cityGuide->name }}" class="guide img-fluid">
            </div>
            <div class="col-md-6 text-center mt-4">
              <img src="{{ asset('upload/cities/' . $cityGuideDetail->image4) }}" alt="{{ $cityGuide->name }}" class="guide img-fluid">
            </div>
          </div>
        @endforeach
      @endif
