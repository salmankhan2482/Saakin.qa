        ...
        <div class="sidebar-left">
          <div class="widget filter-widget">
            ...
            <div class="widget-title widget-collapse">
              ...
              <a class="ml-auto" data-toggle="collapse" href="#filter-property" role="button" aria-expanded="true"
                  ...
                  <div class="col-12 mb-3">
                    <div class="filter-sub-area style1">
                      <div class="filter-title">
                        <p>Select Price Range <span><input type="text" id="amount_two"></span>
                        </p>
                      </div>
            ...
            <div class="tab-pane fade show active property-grid" id="grid-view">
              <div class="row row-10-padding">
                ...
                <div class="col-md-6 col-lg-4 col-sm-12" style="cursor: pointer;"
                  onclick="window.location='{{url(strtolower($property->property_purpose).'/'.$property->property_slug.'/'.$property->id)}}';">
                  <div class="single-property-box">
                    <div class="property-item">
                      ...
                      <ul class="feature_text">
                        <li class="feature_cb"><span> @if($property->featured_property==1)
                            Featured @endif</span></li>
                        <li class="feature_or"><span>For {{$property->property_purpose}}</span>
                        </li>
                      </ul>
                      <div class="property-author-wrap">
                        <ul class="save-btn">
                          <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Bookmark"><a
                              href="#"><i class="lnr lnr-heart"></i></a></li>
                          <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Add to Compare">
                            <a href="#"><i class="fas fa-chart-area"></i></a></li>
                        </ul>
                    ...
                    <div class="property-title-box">
                      ...
                      <ul class="property-feature">
                        ...
                        <li><i class="fas fa-chart-area"></i><span>{{$property->land_area}}
                            sqft</span></li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="single-property-box">
                <div class="row">
                  <div class="col-md-6 col-sm-12">
                    <div class="property-item">
                      ...
                      <div class="property-author-wrap">
                        ...
                        <ul class="save-btn">
                          <li data-toggle="tooltip" data-placement="top" title="Photos"><a href=".html"
                              class="btn-gallery"><i class="lnr lnr-camera"></i></a></li>
                          <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Bookmark"><a
                              href="#"><i class="lnr lnr-heart"></i></a></li>
                          <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Add to Compare">
                            <a href="#"><i class="fas fa-chart-area"></i></a></li>
                  ...
                  <div class="col-md-6 col-sm-12">
                    <div class="property-title-box">
                      <h4><a
                          href="{{url('property/'.$property->property_slug.'/'.$property->id)}}">{{$property->property_name}}</a>
                      </h4>
                      <div class="property-location">
                        <i class="fa fa-map-marker-alt"></i>
