													...
													<div class="tab-pane fade show active" id="login" role="tabpanel">
														...
														<div class="row">
															...
															<div class="col-md-12">
																...
																'search-form', 'id' => 'loginform', 'role' => 'form',
																'autocomplete' => 'on']) !!}
																@csrf
																<div class="form-group res-box text-center mt-10 mb-10">

																	<a href="{{ route('facebook.login') }}" type="submit" class="btn v8 facebook-button">
																		<span>
																...
																<div class="form-group res-box text-center mt-10 mb-10">
																	...
																	<a href="{{ route('google.login') }}" type="submit" class="btn v8 google-button">
																		<span>
																...
																<div class="form-group">
																	<input type="email" class="form-control" tabindex="1"
																		placeholder="{{ trans('words.email') }}" name="email" id="email"
																...
																<div class="form-group">
																	...
																	<input placeholder="{{ trans('words.password') }}" class="form-control"
																		type="password" name="password" id="password" style="margin-bottom: 5px;" />
													...
													<div class="tab-pane fade" id="register" role="tabpanel">
														...
														<div class="row">
															<div class="col-md-12">
																...
																'search-form', 'id' => 'registerform', 'role' =>
																'form']) !!}
																<div class="form-group">
																	<input type="text" class="form-control" placeholder="{{ trans('words.name') }}"
																		name="name" id="name" style="margin-bottom: 5px;" />
																	@if ($errors->has('name'))
																	<span style="color:#fb0303">
																		{{ $errors->first('name') }}
																	</span>
																...
																<div class="form-group">
																	<input type="email" class="form-control" placeholder="{{ trans('words.email') }}"
																		name="email" id="email" style="margin-bottom: 5px;" />
																	@if ($errors->has('email'))
																	<span style="color:#fb0303">
																		{{ $errors->first('email') }}
																	</span>
																...
																<div class="form-group">
																	<input class="form-control" type="password"
																		...
																		id="password_confirmation" style="margin-bottom: 5px;" />
