...
@section('content')
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/blog-category/list') }}" class="btn btn-default-light btn-xs"><i
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(['url' => ['admin/blog-category/update/' . $blogCategory->id], 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
