...
@section('content')
    ...
    <div id="main">
        <div class="page-header">
            <h2> {{ isset($plan_info->id) ? trans('words.edit') . ': ' . $plan_info->plan_name : trans('words.add') . ' ' . trans('words.plan') }}
            </h2>

            <a href="{{ URL::to('admin/subscription_plan') }}" class="btn btn-default-light btn-xs"><i
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(['url' => ['admin/subscription_plan/add_edit_plan'], 'class' => 'form-horizontal padding-15', 'name' => 'plan_form', 'id' => 'plan_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="plan_name"
                            value="{{ isset($plan_info->plan_name) ? $plan_info->plan_name : null }}"
                            class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="plan_duration"
                            value="{{ isset($plan_info->plan_duration) ? $plan_info->plan_duration : null }}"
                            class="form-control">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="plan_price"
                            value="{{ isset($plan_info->plan_price) ? $plan_info->plan_price : null }}"
                            class="form-control">
                    </div>
                </div>
                <div class="form-group">
