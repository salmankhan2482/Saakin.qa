    ...
    <div id="main">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(['url' => ['admin/users/edituser/' . $user->id], 'class' => 'form-horizontal padding-15', 'name' => 'user_form', 'id' => 'user_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        @else
                            <select name="agency_id" id="agency_id" class="selectpicker show-tick form-control"
                                ...
                                @foreach ($agencies as $agency)
                                    <option value="{{ $agency->id }}" @if ($agency->id == $user->agency_id) selected @endif>{{ $agency->name }}
                                    </option>
                                @endforeach
                            </select>
                        @endif
