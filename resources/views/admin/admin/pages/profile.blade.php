    ...
    <div role="tabpanel">
        ...
        <div class="tab-content tab-content-default">
            <div role="tabpanel" class="tab-pane active" id="account">
                ...
                padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' =>
                'multipart/form-data')) !!}
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{URL::asset('upload/agencies/'.$agency->image)}}"
                                    width="200" alt="person">
                                @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="whatsapp" value="{{ Auth::user()->whatsapp }}" class="form-control"
                            value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea name="about" cols="50" rows="5"
                            class="form-control" required>{{$agency->agency_detail}}</textarea>
                    </div>
                </div>
                @else
                <div class="form-group">
            ...
            <div role="tabpanel" class="tab-pane" id="ac_password">
                ...
                {!! Form::open(array('url' => 'admin/profile_pass','class'=>'form-horizontal
                padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
