...
@section('content')
    ...
    <div id="main">
        <div class="page-header">
            <h2> {{ isset($user->name) ? trans('words.edit') . ': ' . $user->name : trans('words.add') . ' ' . trans('words.user') }}
            </h2>

            <a href="{{ URL::to('admin/users') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i>
                {{ trans('words.back') }}</a>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(['url' => ['admin/users/adduser'], 'class' => 'form-horizontal padding-15', 'name' => 'user_form', 'id' => 'user_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" value="{{ isset($user->name) ? $user->name : null }}"
                            class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea name="about" cols="50" rows="5"
                            class="form-control">{{ isset($user->about) ? $user->about : null }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Facebook</label>
                    <div class="col-sm-9">
                        <input type="text" name="facebook" value="{{ isset($user->facebook) ? $user->facebook : null }}"
                            class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="twitter" value="{{ isset($user->twitter) ? $user->twitter : null }}"
                            class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="instagram"
                            value="{{ isset($user->instagram) ? $user->instagram : null }}" class="form-control"
                            value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="linkedin" value="{{ isset($user->linkedin) ? $user->linkedin : null }}"
                            class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="media">
                            <div class="media-left">
                                @if (isset($user->image_icon))
                                    ...
                                    <img src="{{ URL::asset('upload/members/' . $user->image_icon . '-s.jpg') }}" width="80"
                                        alt="person">
                                @endif
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                        <button type="submit"
                            class="btn btn-primary">{{ isset($user->name) ? trans('words.save_changes') : trans('words.submit') }}</button>
