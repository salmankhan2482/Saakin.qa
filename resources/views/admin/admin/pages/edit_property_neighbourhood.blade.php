...
@section('content')
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/properties/neighbourhood/' . $property_id) }}"
                class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> {{ trans('words.back') }}</a>
        </div>
        @if (count($errors) > 0)
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 col-md-3">
                        @if (isset($property_gallery_image->image_name))
                            <img src="{{ URL::asset('upload/neighbourhood/' . $property_gallery_image->image_name) }}"
