    ...
    <div id="main">
        <div class="page-header">
            <div class="pull-right">
                <a href="{{ URL::to('admin/agency/create') }}"
                    class="btn btn-primary">{{ trans('words.add') . ' ' . trans('words.agency') }} <i
                        class="fa fa-plus"></i></a>
                <a href="{{ URL::to('admin/agencies/export') }}" class="btn btn-success">Export<i
                        class="fa fa-download"></i></a>
                <a href="javascript:void(0)" data-toggle="modal" data-target="#import" class="btn btn-info">Import<i
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="btn btn-icon waves-effect cu_btn waves-light btn-danger m-b-5"
                                        onclick="importAgencies('{{ $agency->id }}')"> <i class="fa fa-upload"></i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
