                    ...
                    <div class="property-amenities-box">
                        ...
                        @if (count($cityGuideDetails) > 0)
                            @foreach ($cityGuideDetails as $i => $cityGuideDetail)
                                <h5 class="mt-35 w-100 mb-0 d-inline-block">{{ $i + 1 }}:-
                                    {{ $cityGuideDetail->title }}</h5>
                                    ...
                                    <div class="gal">
                                        <div class="col-md-6 text-center mt-4">
                                            <img src="{{ asset('upload/cities/' . $cityGuideDetail->image1) }}"
                                                alt="{{ $cityGuideDetail->image1 }}" class="img-fluid">
                                        </div>
                                        <div class="col-md-6 text-center mt-4">
                                            <img src="{{ asset('upload/cities/' . $cityGuideDetail->image2) }}"
                                                alt="{{ $cityGuideDetail->image2 }}" class="img-fluid">
                                        </div>
                                        <div class="col-md-6 text-center mt-4">
                                            <img src="{{ asset('upload/cities/' . $cityGuideDetail->image3) }}"
                                                alt="{{ $cityGuideDetail->image3 }}" class="img-fluid">
                                        </div>
                                        <div class="col-md-6 text-center mt-4">
                                            <img src="{{ asset('upload/cities/' . $cityGuideDetail->image4) }}"
                                                alt="{{ $cityGuideDetail->image4 }}" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
