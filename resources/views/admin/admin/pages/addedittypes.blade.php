        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="property_type" value="{{ isset($type->types) ? $type->types : null }}"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                        <button type="submit"
                            class="btn btn-primary">{{ isset($type->id) ? trans('words.save_changes') : trans('words.submit') }}</button>
