  ...
  @endif
    ...
    <div class="panel panel-default">
            <div class="panel-body">               
                {!! Form::open(array('url' => array('admin/properties_for_purpose_page'),'class'=>'form-horizontal padding-15','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="meta_title" name="meta_title" class="form-control" value="{{ isset($page_info->meta_title) ? stripslashes($page_info->meta_title) : null }}">
                    </div>
                </div>
