            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Route</label>
                      <div class="col-sm-9">
                        <input type="text" name="route" id="route" value="{{ $menu->route }}" value="" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Icon</label>
                      <div class="col-sm-9">
                        <input type="text" name="icon" id="icon" value="{{ $menu->icon }}" value="" class="form-control" required>
                    </div>
                </div>
