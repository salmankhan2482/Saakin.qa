...
@section("content")
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/properties') }}" class="btn btn-default-light btn-xs"><i
            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="col-md-4">
                            ...
                            <input type="text" placeholder="Agent Name" class="form-control" autocomplete="off" value="{{old('agent_name')}}" name="agent_name" id="agent_name">
                           
                        </div>
                        <div class="col-md-4">
                            <label>Agent Whatsapp</label>
                            <input type="text" placeholder="Whatsapp Number" class="form-control" autocomplete="off" value="{{old('whatsapp')}}" name="whatsapp" id="whatsapp">
