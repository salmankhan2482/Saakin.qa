...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($partners->name) ? trans('words.edit').': '. $partners->name : trans('words.add').' '.trans('words.partner') }}</h2>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($partners->name) ? trans('words.save_changes') : trans('words.submit') }}</button>
