  ...
  @endif
    ...
    <div class="panel panel-default">
            <div class="panel-body">               
                {!! Form::open(array('url' => array('admin/property_type_for_purpose_page'),'class'=>'form-horizontal padding-15','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
