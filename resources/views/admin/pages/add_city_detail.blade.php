...
<div id="main">
	<div class="page-header">
		<h2> {{ trans('words.add').' '.trans('words.city_detail') }}</h2>
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/city-detail/create'), 'method'=>'POST','class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="property_trends" id="property_trends" rows="7"
                            class="form-control">{{ old('property_trends') }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" name="city_image1" class="form-control" required
