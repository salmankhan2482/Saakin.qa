   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" id="name"  value="{{$blogCategory->category}}" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="description" id="description" rows="7" class="form-control">{{$blogCategory->description}}</textarea>
                    </div>
                </div>
