...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($testimonial->name) ? trans('words.edit').': '. $testimonial->name : trans('words.add').' '.trans('words.testimonial') }}</h2>
		
		<a href="{{ URL::to('admin/testimonials') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> {{trans('words.back')}}</a>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($testimonial->name) ? trans('words.save_changes') : trans('words.submit') }}</button>
