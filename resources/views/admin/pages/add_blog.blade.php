...
<div id="main">
	<div class="page-header">
		...
		<a href="{{ URL::to('admin/blogs') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> {{trans('words.back')}}</a>
	</div>
	@if (count($errors) > 0)
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/blog/create'), 'method'=>'POST','class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">{{trans('words.tags')}}</label>
                      <div class="col-sm-9">
                        <input type="text" name="tags" id="tags" placeholder="Add Blog Tags"  value="" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">{{trans('words.meta_title')}}</label>
                      <div class="col-sm-9">
                        <input type="text" name="meta_title" id="meta_title" placeholder="Meta Title"  value="" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="meta_description" placeholder="Meta Description" id="meta_description" rows="7" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="meta_keyword" id="meta_keyword" placeholder="Meta Keywords" rows="7" class="form-control"></textarea>
                    </div>
                </div>
