	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/agency/update/'.$agency->id), 'method'=>'POST','class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'update_agency','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="col-sm-9">
                    <input type="number" name="whatsapp" id="whatsapp" value="{{ $agency->whatsapp }}" class="form-control">
                </div>
            </div>

                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Email *<small style="font-size: 11px; color:#F00">(email will be agency login)</small></label>
                    <div class="col-sm-9">
                ...
                <div class="col-sm-6">
                    <input type="text" name="password" id="passwordgenerator" value="{{old('password')}}" class="form-control">
                </div>
                <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="access_code" id="access_code"  value="{{ $agency->access_code }}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Group Code</label>
                    <div class="col-sm-9">
                        <input type="text" name="group_code" id="group_code"  value="{{ $agency->group_code }}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Head Office*</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="head_office" id="head_office" rows="4" class="form-control">{{ $agency->head_office }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="detail" id="detail" rows="7" class="form-control">{{ $agency->agency_detail }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Meta Title" name="meta_title" value="{{ $agency->meta_title }}" id="meta_title" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" placeholder="Meta Description" name="meta_description" id="meta_description" rows="4" class="form-control">{{ $agency->meta_description }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" placeholder="Meta Keyword" name="meta_keyword" id="meta_keyword" rows="7" class="form-control">{{ $agency->meta_keyword }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="button" id="add_update_Agency" class="btn btn-primary">{{ trans('words.submit') }}</button>
                    </div>
                </div>
