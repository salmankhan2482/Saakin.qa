    ...
    <div id="main">
        ...
        @if (isset($floor_plan_id))
            <div class="panel-body">
                <div class="col-md-8">
                    {!! Form::open(['url' => ['admin/properties/floor-plan/' . $property_id . '/edit/' . $floor_plan_id], 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="floor_name" id="floor_name"
                                value="{{ $propertyFloorPlan->floor_name }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="floor_size" id="floor_size"
                                value="{{ $propertyFloorPlan->floor_size }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="floor_rooms" id="floor_rooms"
                                value="{{ $propertyFloorPlan->floor_rooms }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="floor_bathrooms" id="floor_bathrooms"
                                value="{{ $propertyFloorPlan->floor_bathrooms }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                            @if (isset($propertyFloorPlan->floor_images))
                                <img src="{{ URL::asset('upload/floorplan/' . $propertyFloorPlan->floor_images) }}"
                                    width="100" alt="{{ $propertyFloorPlan->floor_images }}">
                            @endif
                        </div>
                    </div>
        ...
        @else
            <div class="panel-body">
                <div class="col-md-8">
                    {!! Form::open(['url' => ['admin/properties/floor-plan/' . $property_id . '/create'], 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        <div class="col-sm-4">
                            <label>Floor Name</label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="floor_bathrooms" id="floor_bathrooms" value="" class="form-control"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <tbody>
                        @foreach ($floorPlans as $i => $floorPlan)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ URL::asset('upload/floorplan/' . $floorPlan->floor_images) }}" width="180"
                                        alt="{{ $floorPlan->floor_name }}" />
                                </td>
                                <td class="text-center">
                                    <a href="{{ url('admin/properties/floor-plan/' . $floorPlan->property_id . '/edit/' . $floorPlan->id) }}"
                                        class="btn btn-icon waves-effect waves-light btn-success m-b-5 m-r-5"
                                        data-toggle="tooltip" title="{{ trans('words.edit') }}"> <i
                                            class="fa fa-edit"></i> </a>
                                    <a href="{{ url('admin/properties/floor-plan/' . $floorPlan->property_id . '/delete/' . $floorPlan->id) }}"
