    ...
    <div id="main">
        ...
        @if (isset($gid))
            <div class="panel-body">
                <div class="col-md-6">
                    {!! Form::open(['url' => ['admin/properties/gallery/' . $property_id . '/edit/' . $gid], 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
        ...
        @else
            <div class="panel-body">
                <div class="col-md-12">
                    {!! Form::open(['url' => ['admin/properties/gallery/' . $property_id . '/create'], 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        <div class="col-lg-12">
                        ...
                        @foreach ($galleryImages as $i => $galleryImage)
                            <tr class="draggable">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ url('admin/properties/gallery/' . $galleryImage->property_id . '/delete/' . $galleryImage->id) }}"
