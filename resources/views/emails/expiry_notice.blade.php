    ...
    <table  cellpadding="0" cellspacing="0" width="60%"
        ...
        <tr style="border:0">
            <td style="text-align:center">
                <a href="{{ url('/') }}" target="_blank">
                    <img src="{{ URL::asset('upload/logo.png') }}" alt="Logo"></a>
            </td>
        </tr>
        <tr style="border:0">
            <td>
        ...
        <tr>
            <td style="padding: 20px 0 30px 0;line-height:22px;">
                Your property <b>{{ $property_name }}</b> on {{ getcong('site_name') }} has been expired.<br />
                <br />
        ...
        <tr>
            <td style="text-align:center; margin:10px auto;float:left;width:100%;line-height:48px;">
                <a href="{{ URL::to('login/') }}"
                    style="font-size: 15px;margin-bottom:10px;text-align: center;background: #007ee6;color: #fff;border-radius: 6px;text-decoration:none;padding:15px 30px;">Login</a>
            </td>
        </tr>
        <tr>
