...
<head>
    <title>Saakin Inc. | Real Estate Directory in Qatar</title>
    <meta charset="utf-8" />
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:13px;color:#8c9497;">+97470125000</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        src="{{ URL::asset('assets/images/black_logo.png') }}"
                                                    ...
                                                    <table border="0" cellpadding="3" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        style="font-size: 14px; mso-line-height-alt: 25.2px; color: #000000; line-height: 1.8; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                    ...
                                                    <table border="0" cellpadding="5" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #ff0404; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                ...
                                                                <table align="center" border="0" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:0 2px 0 2px;"><a
                                                                                href="https://facebook.com/SaakinQatar/"
                                                                        ...
                                                                        <td style="padding:0 2px 0 2px;"><a
                                                                                href="https://twitter.com/saakinqatar"
                                                                        ...
                                                                        <td style="padding:0 2px 0 2px;"><a
                                                                                href="https://instagram.com/saakin.realestate/"
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{ asset('upload/instagram.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                                    title="Instagram" width="32" /></a>
                                                                        </td>
                                                                        <td style="padding:0 2px 0 2px;"><a
                                                                                href="https://linkedin.com/company/saakin"
                                                                                target="_blank"><img alt="LinkedIn"
                                                                                    height="32"
                                                                                    src="{{ asset('upload/linkedin.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            you can find <a
                                                                                ...
                                                                                Qatar</a>. For apartments on rent real
                                                                            estate agents in Qatar bring you the best
                                                                            apartments in Doha, The Pearl, West Bay, and
                                                                            properties from all over the country though
                                                                            Qatar property directory
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
