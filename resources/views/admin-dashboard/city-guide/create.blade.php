                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            {!! Form::open(['route' => 'cities.store', 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea type="text" id="meta_description" rows="5" name="meta_description" class="form-control"
                                        placeholder="Meta Description"></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Meta Keywords</label>
                                    <textarea type="text" id="meta_keyword" rows="5" name="meta_keyword" class="form-control"
