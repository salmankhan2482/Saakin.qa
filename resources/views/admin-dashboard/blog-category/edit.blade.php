            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open(array('route' => ['blog-category.update',$blogCategory->id] , 'method'=>'POST','class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
