                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            {!! Form::open(['route' => 'users.update', 'method' => 'POST', 'class' => 'form-horizontal padding-15', 'name' => 'type_form', 'id' => 'type_form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="text" rows="4" id="url" name="url" class="form-control"
                                        placeholder="Write Details">{{ $user->about }}</textarea>
                                </div>
                            </div>
                            <hr />
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="icon" name="icon" value="{{ $user->facebook }}" class="form-control" placeholder="Link">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Twitter</label>
                                    <input type="text" id="icon" name="icon" value="{{ $user->twitter }}" class="form-control" placeholder="Link">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Instagram</label>
                                    <input type="text" id="icon" name="icon" value="{{ $user->instagram }}" class="form-control" placeholder="Link">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>LinkedIn</label>
                                    <input type="text" id="icon" name="icon" value="{{ $user->linkedin }}" class="form-control" placeholder="Link">
                                </div>
                            </div>
                            <hr />
                            <div class="form-row">
