                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display min-w850">
                            ...
                            <td>2011/04/25</td> --}}
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('menuOptions.edit', $menuOption->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a href="{{ route('menuOptions.destroy', $menuOption->id) }}" class="btn btn-danger shadow btn-xs sharp"><i
