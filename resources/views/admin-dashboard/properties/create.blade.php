                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select id="bedrooms" name="bedrooms"
                                                    ...
                                                    <option value="10" @if (old('bedrooms') == '10') selected @endif>
                                                        10
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select name="bathrooms" id="bathrooms"
                                                    ...
                                                    <option value="10" @if (old('bathroom') == '10') selected @endif>
                                                        10
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input type="number" name="price" class="form-control" id="p-price"
                                                    min="0" placeholder="{{ trans('words.price') }}"
                                                    value="{{ old('price') }}" required>
                                            </div>
                                            <div class="col-3">
                                                <label>Property Size</label>
                                                <input type="number" name="land_area" class="form-control"
                                                    id="p-land_area" min="0"
                                                    placeholder="{{ trans('words.land_area') }} sq.ft"
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="file" name="property_document" multiple=""
                                                    class="form-control">
                                            </div>
                                    ...
                                    <div class="m-4">
                                        <button id="SaveProperty" type="submit" class="btn btn-rounded btn-success">Save
                                            </button>
                                    </div>
                                    {!! Form::close() !!}
                                </div>
