        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Terms of Use Page Content</h4>
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open(array('route' => ['update_terms_page'],'class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
