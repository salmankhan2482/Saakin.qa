        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">City Guide Page Content</h4>
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open(array('route' => ['city-guide-landing-pages.update'],'method'=> 'PUT', 'class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form',
                        ...
                        <input type="hidden" name="id" value="{{ isset($data['page_info']->id) ? $data['page_info']->id : null }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="card-body">
                                        <textarea id="page_content" name="page_content">{{ isset($data['page_info']->page_content) ? stripslashes($data['page_info']->page_content) : null }}</textarea>
                                    </div>
                                </div>
                            </div>
