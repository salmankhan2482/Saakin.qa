        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">FAQ's Page Content</h4>
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open(array('route' => ['update_faq_page'],'class'=>'form-horizontal padding-15','name'=>'type_form','id'=>'type_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
